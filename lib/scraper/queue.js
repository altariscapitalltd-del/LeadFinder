...
function queueLink(db, jobId, url, depth, config, parentUrl, pageKind = "page") {
  if (shouldSkipUrl(url)) return;
  const priority = scoreUrlForCrawl(db, url, config, parentUrl);
  db.prepare(`
